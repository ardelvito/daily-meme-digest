...
//                    Log.d("Date", month.toString() + year.toString())
    ...
    override fun onCreateView(
        ...
        circleImg = v?.findViewById(R.id.editPhotoProfile)
...
//            if(getActivity()?.let { ContextCompat.checkSelfPermission(it.getApplicationContext(), android.Manifest.permission.CAMERA) } !=
...
//            val shareIntent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
